...
li x31, 0
beq s11, x31, supervisor_block_0_71ef5e7a
li x31, 1
beq s11, x31, supervisor_block_1_71ef5e7a
li x31, 2
beq s11, x31, supervisor_block_2_71ef5e7a
li x31, 3
beq s11, x31, supervisor_block_3_71ef5e7a
li x31, 4
beq s11, x31, supervisor_block_4_71ef5e7a
li x31, 5
beq s11, x31, supervisor_block_5_71ef5e7a
j end_supervisor_code_71ef5e7a

supervisor_block_0_71ef5e7a:
    csrrc t1, sstatus, s6
    j end_supervisor_code_71ef5e7a

supervisor_block_1_71ef5e7a:
    csrrs s7, sstatus, a7
    j end_supervisor_code_71ef5e7a

supervisor_block_2_71ef5e7a:
    csrrc s10, sstatus, t4
    j end_supervisor_code_71ef5e7a

supervisor_block_3_71ef5e7a:
    csrrc a7, sstatus, a4
    j end_supervisor_code_71ef5e7a

supervisor_block_4_71ef5e7a:
    csrrs a3, sstatus, s6
    j end_supervisor_code_71ef5e7a

supervisor_block_5_71ef5e7a:
    csrrc s8, sstatus, a7
    j end_supervisor_code_71ef5e7a

end_supervisor_code_71ef5e7a:
    li x31, 0xf0001004
    ecall

...
SID_SSTC_02_M_HS:
	...
	csrrs t5, menvcfg, t6
	# Set mcounteren.tm=1
	csrrsi s0, mcounteren, 0x2
	# Set hcounteren.tm=0
	csrrci a5, hcounteren, 0x2
...
SID_SSTC_03_NON_U:
	...
	andi sp, sp, -16
	# Set mcounteren.tm=1
	csrrsi s10, mcounteren, 0x2
	# Set hcounteren.tm=1
	csrrsi s2, hcounteren, 0x2
	# Set scounteren.tm=0
	csrrci s2, scounteren, 0x2
...
SID_SSTC_06:
	...
	and t2, s2, t1
	li s0, 0
	beq t2, s0, pass_label_0
	li s9, failed_addr
	ld t5, 0(s9)
	jr t5
pass_label_0:
	li a0, 0x8000000000000000
	csrrc s10, henvcfg, a0
	csrr s9, henvcfg
	and s3, s9, t1
	li t4, 0
	beq s3, t4, pass_label_1
	li s9, failed_addr
	ld a1, 0(s9)
	jr a1
pass_label_1:
...
SID_SSTC_08:
	...
	csrr s4, mip
	andi t1, s4, 0x20
	beq t1, s11, pass_label_2
	li t6, failed_addr
	ld s3, 0(t6)
	jr s3
pass_label_2:
	beq t1, s8, pass_label_3
	li s4, failed_addr
	ld a0, 0(s4)
	jr a0
pass_label_3:
	beq s8, s11, pass_label_4
	li a7, failed_addr
	ld t1, 0(a7)
	jr t1
pass_label_4:

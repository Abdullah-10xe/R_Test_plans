...
SID_SSTC_03_NON_U:
	...
	;#csr_rw(mcounteren, set, false, false)
	# Set hcounteren.tm=1
	csrrsi a1, hcounteren, 0x2
	# Set scounteren.tm=0
	csrrci s8, scounteren, 0x2
...
SID_SSTC_06:
	...
	and a2, s3, s7
	li s6, 0
	beq a2, s6, pass_label_0
	li s3, failed_addr
	ld s6, 0(s3)
	jr s6
pass_label_0:
	li s11, 0x8000000000000000
	csrrc s2, henvcfg, s11
	csrr t5, henvcfg
	and a5, t5, s7
	li t6, 0
	beq a5, t6, pass_label_1
	li a7, failed_addr
	ld s9, 0(a7)
	jr s9
pass_label_1:

...
SID_ZICBO_019:
	...
	li s2, mem6
	lw s9, 0(s2)
	beq s7, s7, pass_label_1
	li t4, failed_addr
	ld a7, 0(t4)
	jr a7
pass_label_1:
	beq s9, s9, pass_label_2
	li s3, failed_addr
	ld a4, 0(s3)
	jr a4
pass_label_2:
...
SID_ZICBO_020:
	...
	li s11, mem8
	lw t4, 0(s11)
	beq s5, s5, pass_label_3
	li s9, failed_addr
	ld a3, 0(s9)
	jr a3
pass_label_3:
	beq t4, t4, pass_label_4
	li s3, failed_addr
	ld s9, 0(s3)
	jr s9
pass_label_4:

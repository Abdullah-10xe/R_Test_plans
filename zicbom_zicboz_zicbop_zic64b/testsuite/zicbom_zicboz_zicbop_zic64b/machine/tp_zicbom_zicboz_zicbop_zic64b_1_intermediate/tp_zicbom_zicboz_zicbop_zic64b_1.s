...
SID_ZICBO_019:
	...
	andi sp, sp, -16
	li s11, 0xf0
	csrrs a3, menvcfg, s11
	li s11, 0xf0
	csrrs s5, senvcfg, s11
	li a6, 0xf0
	csrrs t1, henvcfg, a6
	...
	li s4, mem6
	lw a1, 0(s4)
	beq a0, a0, pass_label_1
	li s4, failed_addr
	ld s9, 0(s4)
	jr s9
pass_label_1:
	beq a1, a1, pass_label_2
	li s4, failed_addr
	ld a0, 0(s4)
	jr a0
pass_label_2:
...
SID_ZICBO_50_ZIC64B_01:
	...
	csrrs a7, menvcfg, s3
	li t1, 0xf0
	csrrs s10, senvcfg, t1
	li s11, 0xf0
	csrrs t5, henvcfg, s11
	# Set up memory region

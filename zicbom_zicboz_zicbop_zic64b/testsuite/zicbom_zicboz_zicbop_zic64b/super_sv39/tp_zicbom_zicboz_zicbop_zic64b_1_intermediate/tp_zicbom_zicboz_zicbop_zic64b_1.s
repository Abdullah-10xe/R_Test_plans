...
SID_ZICBO_020:
	...
	li s11, mem11
	lw a4, 0(s11)
	beq a1, a1, pass_label_3
	li t2, failed_addr
	ld s9, 0(t2)
	jr s9
pass_label_3:
	beq a4, a4, pass_label_4
	li s6, failed_addr
	ld t5, 0(s6)
	jr t5
pass_label_4:
...
;#page_mapping(lin_name=mem12, phys_name=mem12_phys, pagesize=['4kb'], v=0, r=1, w=0, x=0)
;#init_memory @mem12
.dword 0xc001c0de
...
;#page_mapping(lin_name=mem15, phys_name=mem15_phys, pagesize=['4kb'], v=1, r=1, w=1, x=1)
;#init_memory @mem15
.dword 0xc001c0de
